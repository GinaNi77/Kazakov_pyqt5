...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(827, 720)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")

        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(700, 670, 111, 31))
        ...
        self.pushButton.setGeometry(QtCore.QRect(20, 680, 111, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Список товаров в заказах"))
        ...
        item.setText(_translate("MainWindow", "Сумма товара"))

        self.label.setText(_translate("MainWindow", "Код заказа"))
        self.label_3.setText(_translate("MainWindow", "Код товара"))
        self.label_4.setText(_translate("MainWindow", "Количество товара"))
